  ...
  theme: {
    extend: {
      colors: {
        ...
        eerieBlack: '#1f1f1f',
        onyx: '#5b5b5b',
        mainColor1: 'rgb(97 52 246)',
        mainColor2: 'rgb(38 237 255)',
        button: '#5070f8',
      },
      boxShadow: {
      ...
      backgroundImage: {
        ...
        hero: 'linear-gradient(135deg, rgba(255, 255, 255, 0.8) 60%, rgb(97 52 246) 60%, rgb(38 237 255))',
        'hero-mobile':
          'linear-gradient(135deg, rgba(255, 255, 255, 0.8) 60%, rgb(97 52 246) 60%, rgb(38 237 255))',
      },
      backgroundColor: {
        about: "#fff" 
      },
